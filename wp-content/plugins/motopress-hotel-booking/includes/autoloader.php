...
class Autoloader {
	...
	private function setupCustomPathList(){
		...
		// iCalendar lib
		$this->customPathList['Libraries\\iCalendar\\ZCiCal']			 = 'libraries/ZContent-icalendar/zapcallib.php';
		$this->customPathList['Libraries\\iCalendar\\ZCiCalNode']		 = 'libraries/ZContent-icalendar/zapcallib.php';
		$this->customPathList['Libraries\\iCalendar\\ZCiCalDataNode']	 = 'libraries/ZContent-icalendar/zapcallib.php';
		$this->customPathList['Libraries\\iCalendar\\ZDateHelper']		 = 'libraries/ZContent-icalendar/zapcallib.php';
		$this->customPathList['Libraries\\iCalendar\\ZCRecurringDate']	 = 'libraries/ZContent-icalendar/zapcallib.php';
		$this->customPathList['Libraries\\iCalendar\\ZCTimeZoneHelper']	 = 'libraries/ZContent-icalendar/zapcallib.php';
	}
