...
class SyncLogsListTable extends \WP_List_Table
{
    ...
    public function column_status($item)
    {
        ...
        switch ($item['status']) {
            case 'success': $text = __('Success', 'motopress-hotel-booking'); break;
            case 'info':    $text = __('Info', 'motopress-hotel-booking');    break;
            case 'warning': $text = __('Warning', 'motopress-hotel-booking'); break;
            case 'error':   $text = __('Error', 'motopress-hotel-booking');   break;

            default: $text = ucfirst(str_replace('-', ' ', $item['status'])); break;
        }
